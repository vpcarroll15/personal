    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sms.User')),
            ],
        ),
        migrations.AddIndex(
            model_name='datapoint',
            index=models.Index(fields=['user', '-created_at'], name='sms_datapoi_user_id_8be143_idx'),
        ),
    ]
